...
#define LIN_MSG_USE_STANDARD_PARITY 0x04  // Use enhanced (2.x) parity for the specified msg
#define LIN_MSG_USE_ENHANCED_PARITY 0x08  // Use standard (1.x) parity for the specified msg
